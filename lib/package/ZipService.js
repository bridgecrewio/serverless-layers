  ...
  (0, _createClass2["default"])(ZipService, [{
    ...
    value: function _package() {
      ...
      var _this$plugin$settings = this.plugin.settings,
          ...
          runtimeDir = _this$plugin$settings.runtimeDir; // const zipFileName = this.plugin.getPathZipFileName();

      var layersDir = path.join(process.cwd(), compileDir);
      var shouldZipExternalLibraries = !this.plugin.slsLayersConfig.shouldInstallPackages;

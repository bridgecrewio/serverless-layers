        ...
        return _regenerator["default"].wrap(function _callee5$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
              ...
              case 28:
                this.log('[serverless-layers-yuval] ', process.env.SLS_LAYERS_FORCE_DEPLOY); // It checks if something has changed

                verifyChanges = [hasZipChanged, hasDepsChanges, hasFoldersChanges, hasSettingsChanges, process.env.SLS_LAYERS_FORCE_DEPLOY].some(function (x) {
                  return x === true;
              ...
              case 33:
                ...
                this.log("".concat(chalk.inverse.green(' No changes '), "! Using same layer arnn: ").concat(this.logArn(existentLayerArn)));

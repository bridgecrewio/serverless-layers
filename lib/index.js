          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
              ...
              case 32:
                ...
                this.log("[serverless-layers] - SLS_LAYERS_FORCE_DEPLOY is ".concat(process.env.SLS_LAYERS_FORCE_DEPLOY)); // It improves readability

                skipInstallation = !verifyChanges && !forceInstall && existentLayerArn && process.env.SLS_LAYERS_FORCE_DEPLOY !== 'true';
                /**

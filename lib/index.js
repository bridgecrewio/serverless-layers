...
var ServerlessLayers = /*#__PURE__*/function () {
  ...
  (0, _createClass2["default"])(ServerlessLayers, [{
    ...
    value: function () {
      var _hasCustomHashChanged = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee5(hashFileName) {
        var remoteHashFile, _JSON$parse, remoteHash;
      ...
      function hasCustomHashChanged(_x3) {
    ...
    value: function () {
      var _main = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee6() {
        var _this$settings, arn, localDir, artifact, forceInstall, dependencyInstall, hasSettingsChanges, hasFoldersChanges, hasDepsChanges, hasZipChanged, hashFileName, hashCustomHashChanged, verifyChanges, existentLayerArn, skipInstallation, layerVersionArn, layerName;
          ...
          while (1) {
            switch (_context6.prev = _context6.next) {
              ...
              case 28:
                ...
                _context6.next = 31;
                return this.hasCustomHashChanged(hashFileName);
              ...
              case 61:
                _context6.next = 63;
                return this.layersService.publishVersion().LayerVersionArn;
              ...
              case 71:
                console.log("[ LayersPlugin - Artifacts ]: going to relate layer, layer arn - ".concat(layerVersionArn, ", layer name - ").concat(layerName));
    ...
    value: function getLayerName() {
      var stackName = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : this.getStackName();

          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
              ...
              case 32:
                ...
                this.log("[serverless-layers-yuval] - all condition: verifyChanges: ".concat(verifyChanges, " && forceInstall: ").concat(forceInstall, " && existentLayerArn: ").concat(existentLayerArn)); // It improves readability
